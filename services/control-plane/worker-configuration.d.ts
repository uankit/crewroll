/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/control-plane/wrangler.jsonc --strict-vars=false services/control-plane/worker-configuration.d.ts` (hash: d32e1af555c47265ad8cf9daf8d84ae3)
...
interface __BaseEnv_Env {
  ...
  CLERK_ISSUER: string;
  CLERK_AUTHORIZED_PARTIES_JSON: string;
  ...
  BACKGROUND_CREDENTIAL_HMAC_KEY_V1: string;
  INVITE_CODE_HMAC_KEY: string;
  MEDIA_SIGNING_KEY_V1: string;
  PUSH_TOKEN_ENCRYPTION_KEY_V1: string;
